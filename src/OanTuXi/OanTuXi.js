...
function comRandomChoice(){
    let arr = [ 
      [KEO, keoImg] , [BUA, buaImg] , [BAO, baoImg]
    ]
    ...
    >
      ...
      <div className="row py-5">
        <div className="col-3 text-center d-flex flex-column align-items-center">
           ...
           <div className="speech-bubble d-flex align-items-center" style={{width: "50px",height: "50px", padding: "6px 12px"}}>
          <img src={userChoiceImg} style={{width: "30px",height: "30px"}} alt={userChoice} /> 
     
           </div>

          <img src={require("./oanTuXiImg/player.png")} style={{width: "100px",height: "100px"}} />
         
          
          <div className="d-flex">
              <button className="btn btn-success mx-3" style={{width: "50px",height: "50px"}}
              onClick={()=>{
                setUserChoice(KEO);
              ...
              >
                ...
                <img src={require("./oanTuXiImg/keo.png")} style={{width: "100%",height: "100%"}} />
              </button>
              <button className="btn btn-success mx-3" style={{width: "50px",height: "50px"}}
               onClick={()=>{
                setUserChoice(BUA);
              ...
              <img src={require("./oanTuXiImg/bua.png")} style={{width: "100%",height: "100%"}} />
              </button>
              <button className="btn btn-success mx-3" style={{width: "50px",height: "50px"}}
               onClick={()=>{
                setUserChoice(BAO);
              ...
              <img src={require("./oanTuXiImg/bao.png")} style={{width: "100%",height: "100%"}} />
              </button>
          </div>

        </div>
        <div className="col-6 text-center bg-game">
          <h2 className="h2 text-warning my-3">
             I'm Iron man 
             I love you 3000
          </h2>
        ...
        <div className="col-3 text-center d-flex flex-column align-items-center">
          ...
          <img src={require("./oanTuXiImg/playerComputer.png")} style={{width: "100px",height: "100px"}} />
        </div>
      </div>
    </div>
  );
